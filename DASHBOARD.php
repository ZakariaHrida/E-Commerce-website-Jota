...
<body>
    ...
    <div class="admin-container">
        <nav class="admin-sidebar">
            ...
            <a href="#products" class="menu-item" onclick="showTab('products')">
                 Products
            </a>
            <a href="#orders" class="menu-item" onclick="showTab('orders')">
                 Orders
            </a>
        ...
        <main class="admin-main">
            <div id="dashboard" class="tab-content active">
                ...
                <div class="stats-grid">
                    ...
                    <div class="stat-card">
                        <h3>Total Sales</h3>
                        <div class="value"><?= number_format($total_sales ?: 0, 2) ?> MAD</div>
                    </div>
                    <div class="stat-card">
                        <h3>Total Orders</h3>
                ...
                <div class="stat-card mb-3">
                    ...
                    <div style="display: flex; gap: 1rem; margin-top: 1rem;">
                        <button class="btn btn-primary" onclick="showTab('users')">
                             Add User
                        </button>
                        <button class="btn btn-success" onclick="showTab('products')">
                             Add Product
                        </button>
